...
public class VersionInfoModelImp extends BaseModel implements VersionInfoModel<VersionInfoRet> {
    ...
    @Override
    public void getNewVersion(String channel,IBaseRequestCallBack<VersionInfoRet> iBaseRequestCallBack) {
        ...
        mCompositeSubscription.add(versionInfoService.getNewVersion(requestBody)
