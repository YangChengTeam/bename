...
public class LineChartView extends View {
    ...
    private float rulerTextSizeSP = 12f;//表格标尺文本大小
    ...
    private void drawRulerXText(Canvas canvas, String text, float x, float y) {
        ...
        drawText(canvas, textRulerPaint, text, x - 25, newY);
    }
    ...
    private void drawRulerXValue(Canvas canvas) {
        ...
        for (int i = 0; i < linePoints.length; i++) {
            ...
            if (point == null) break;
            drawRulerXText(canvas, this.xDatas.get(i), linePoints[i].x, 0);
        }
    }
